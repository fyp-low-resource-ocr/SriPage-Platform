...
export class PresignUploadDto {
  ...
  @ApiProperty({ example: 245760, minimum: 1, description: 'File size in bytes.' })
...
export class CreateJobDto {
  ...
  @ApiProperty({ example: 245760, minimum: 1, description: 'File size in bytes.' })
  @IsInt() @Min(1) size!: number;
  @ApiProperty({ example: 'inputs/uuid-invoice.pdf', description: 'Object key returned by the presign endpoint.' })
